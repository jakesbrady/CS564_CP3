class BTreeNode {
    ...
    /**
     * Array of the keys stored in the node. Maps to studentID
     */
    long[] keys;

    /**
     * Array of the values[recordID] stored in the node. This will only be filled when the node is a leaf node. Maps to recordID
     */
    long[] values;
